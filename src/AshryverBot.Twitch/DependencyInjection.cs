...
public static class DependencyInjection
{
    ...
    {
        public IServiceCollection AddTwitchClients(IConfiguration configuration)
        {
        ...
        public IServiceCollection AddTwitchEventSubWebSocket(IConfiguration configuration)
        {
